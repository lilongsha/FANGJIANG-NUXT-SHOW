  ...
  <div class="mx-auto sm:w-full sm:px-2 lg:container">
    ...
    <div class="w-full h-24">
      ...
      <div class="sm:mt-2 lg:mt-4">
        ...
        <span v-else-if="house.type === '6'" class="px-1 py-0.5 font-normal text-white rounded-sm bg-fjBlue-100">别墅</span>
        <span v-else-if="house.type === '7'" class="px-1 py-0.5 font-normal text-white rounded-sm bg-fjBlue-100">商业类</span>
