    ...
    <div class="absolute left-0 flex flex-row items-center justify-center h-full">
      <div class="flex items-center h-full">
        <a href="https://www.fangjiang.com" target="_blank">
          <h1 v-if="getIsHome"><img :alt="getLocation + '新房'" class="object-cover w-16 h-16" src="~/assets/img/white-logo.png" /></h1>
          <span v-if="!getIsHome"><img :alt="getLocation + '新房'" class="object-cover w-16 h-16" src="~/assets/img/blue-logo.png" /></span>
        </a>
      </div>
